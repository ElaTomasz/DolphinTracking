 ...
 * {@link Eula#show(Activity)} in the onCreate() method of the first
 * activity. If the user accepts the EULA, it will never be shown again. If the
 * user refuses, {@link Activity#finish()} is invoked on your
 * activity.
 */
...
class Eula {
	...
	static boolean show(final Activity activity) {
		...
		// Comment this out to allow the EULA to appear only once.
